...
echo "   Main endpoint: https://api.yourdomain.com"
echo "   Account 1: https://api1.yourdomain.com"  
echo "   Account 2: https://api2.yourdomain.com"
echo "   Account 3: https://api3.yourdomain.com"
echo "   Account 4: https://api4.yourdomain.com"
echo "   Account 5: https://api5.yourdomain.com"
echo "   Account 6: https://api6.yourdomain.com"
echo "   Account 7: https://api7.yourdomain.com"
echo "   Account 8: https://api8.yourdomain.com"
echo "   Account 9: https://api9.yourdomain.com"
echo "   Account 10: https://api10.yourdomain.com"